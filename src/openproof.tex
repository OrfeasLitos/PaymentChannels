\begin{figure}[!htbp]
  \begin{systembox}{$\fpaynet{}_{\mathrm{, Open}}$}
    \begin{algorithmic}[1]
      ...
      \redden{\textsc{adversaryOpenChannel}, \textsc{channelAnnounced}} and
...
\begin{figure}[!htbp]
  ...
  \redden{open}}
    ...
    \begin{algorithmic}[1]
      ...
      \redden{\State Upon receiving (\textsc{openChannel}, $x$,
      ...
      \redden{\State Upon receiving (\textsc{adversaryOpenChannel},
      ...
      \EndIndent}
    \end{algorithmic}
    \redden{Continued in Fig.~\ref{alg:sim:open:fundingLocked}}
  \end{simulatorbox}
  \caption{}
  \label{alg:sim:open}
\end{figure}
...
\begin{figure}[!htbp]
  \begin{simulatorbox}{$\simulator{}_{\mathrm{LN - Reg - Open}}$ --
  \redden{funding locked}}
    \redden{Continuing from Fig.~\ref{alg:sim:open}}
    \begin{algorithmic}[1]
...
\begin{proof}
  ...
  \redden{In the ideal world, when the simulated \adversary{} attempts to open a
