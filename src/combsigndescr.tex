...
\label{sec:ov-combined-ds}
  ...
  generating signatures, which is leveraged in the revocation and
  ...
  provide here the concrete syntax and correctness definitions, along with
...
signatures~\cite{DBLP:conf/ndss/NicolosiKDM03,DBLP:journals/iacr/BellareS01,boyd1986digital,DBLP:conf/ndss/Ganesan95a,DBLP:conf/crypto/MacKenzieR01,ganesan1994secure}
  ...
  % TODO: bring Share-EUF game and sec definitions
  ...
  % TODO: bring master-EUF-CMA game and sec definitions
  ...
  \end{theorem}
  % TODO: bring construction
  % TODO: bring proofs
  % TODO: remove appendices
  % TODO: remove and rephrase all dangling refs
