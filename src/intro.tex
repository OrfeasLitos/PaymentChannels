...
scheme and an Identity Based Signature scheme)\redden{, there is also one that} is less standard  \redden{and requires a new definition}. \redden{The \emph{combined digital signature} -- as we
...
the two parties, \redden{called} the shareholder, generates and stores a share of the signing
