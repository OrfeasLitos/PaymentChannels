...
Section~\ref{sec:ov-security-analysis} we provide an overview of the security
proof of the main simulation theorem, along with a useful corollary \TODO{change
to theorem?} security property that \fpaynet{} provides. Finally, in
