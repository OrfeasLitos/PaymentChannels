...
assumptions and setup that is needed \orfeas{check}. The additional side-effect
...
idealised'' ledger functionalities for which it is unknown whether they can be
realised from a network functionality and a global clock). See
Appendix~\ref{appendix:relwork} for more details. \TODO{rephrase in light of
Perfect Ledger Appendix~\ref{appendix:perfectledger}}
