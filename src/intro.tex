...
proof of the main simulation theorem. Furthermore, in
Section~\ref{sec:perfect-ledger} we formalise our claim that a ledger
functionality with instant finality is unrealisable. Subsequently, we refer the reader
to Sections~\ref{appendix:payfunc} and~\ref{appendix:protocol} for the formal
definition of the paynet functionality \fpaynet{} and the protocol
$\Pi_{\mathrm{LN}}$ respectively. Finally, the proof that the latter UC-realises the
former can be found in Section~\ref{appendix:secproof}.
