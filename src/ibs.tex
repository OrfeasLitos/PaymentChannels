\section{Identity Based Signatures primitive}
  As we mentioned in Subsection~\ref{prelim:ibs} \TODO{change ref if current
  removed}, LN uses a custom construction to derive three new keys on each
  ...
  \subsection{Algorithms}
    ...
    complicate the exposition. \orfeas{rephrase?}
