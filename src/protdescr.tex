...
\label{sec:ov-protocol}
  ...
  details~\redden{\cite{full-version}}.
...
%
    ...
    \redden{in the full version~\cite{full-version}} that it actually implements
    an IBS.
    ...
    roles. Furthermore, in order to reduce transaction size and ensure
