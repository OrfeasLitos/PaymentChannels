...
\begin{proof}
  ...
  \texttt{paymentsToReport}(\alice)) to \environment{} and empties these fields
  ...
  \texttt{closedChannels}, \texttt{updatesToReport}, \texttt{paymentsToReport})
  to \environment{} and empties these fields as well
