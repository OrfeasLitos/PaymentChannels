  ...
  \begin{simulatorbox}{$\simulator{}_{\mathrm{LN - Reg - Open - Pay}}$}
    ...
    \begin{algorithmic}[1]
      ...
      \Indent
        ...
        older version (that doesn't contain the HTLC) at block $t$ and
        \charlie{} doesn't \textsc{poll} in time to revoke (is negligent during
        $\left[t + k, t + \mathtt{CharlieDelay}\right]$) OR player after
