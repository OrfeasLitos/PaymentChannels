...
\begin{proof}
  ...
  algorithm (Fig.~\ref{alg:forge:ds}) that wins the \textsf{EUF-CMA} game
  (Fig.~\ref{game:ds}) with non-negligible probability, thus breaking the
  ...
  breaks the Identity Based Signatures scheme with non-negligible probability
