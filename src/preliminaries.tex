...
%    to leverage previous results on the security of blockchains.
  ...
  \noindent \textbf{Hybrid functionalities used.}
    ...
    in Appendix~\ref{appendix:ledger}. The current work makes heavy use of these
    two security properties, as the security of the lightning network relies
    crucially on the security of the underlying ledger.
