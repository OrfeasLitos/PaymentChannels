...
\label{sec:ov-security-proof}
  ...
  \begin{proofsketch}
    The proof is done in 5 steps \redden{of successive game replacement}. In the first lemma, (Lemma~\ref{lemma:dummy} in the appendix) we define a simulator $\simulator_{\mathrm{LN}}$
