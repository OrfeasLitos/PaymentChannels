\section{Combined Sign primitive}
  ...
  \subsection{Construction}
    ...
    \begin{proof}
      ...
      \concat pk^*\right)$ are decided after $\mathcal{B}$ terminates (in
      line~\ref{proof:comb:share:distinguisher:won}) and thus
      \begin{equation}
        \begin{gathered}
          \Pr\left[cpk^* = \textsc{CombinePubKeyGen}\left(mpk, pk^*\right) |
      ...
      $\left(\mathcal{B} \text{ wins} \wedge \neg E\right)$ is not influenced by
      whether $F$ happens or not\orfeas{take a close look}, thus
      \begin{equation*}
