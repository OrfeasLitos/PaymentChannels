\section{Combined Signatures primitive}
  ...
  \begin{definition}
    ...
    \begin{gather*}
      ...
      \ifelseieee{\\}{}
      \text{ (cf. Fig~\ref{game:comb:share})} \enspace.
    \end{gather*}
  \end{definition}
  ...
  \begin{definition}
    ...
    \begin{gather*}
      ...
      \ifelseieee{\\}{}
      \text{ (cf. Fig~\ref{game:comb:master})} \enspace.
    \end{gather*}
  \end{definition}
  ...
  \subsection{Construction}
    ...
    One can check by inspection that the syntax above matches the one required
    by the Combined Signatures scheme definition. Furthermore, assuming that
    \textsc{SignDS}() and \textsc{VerifyDS}() are provided by a correct Digital
    Signature construction, it is straightforward to confirm that the
    ...
    \begin{proof}[Proof of Lemma~\ref{lemma:comb:share}]
    ...
    \begin{proof}[Proof of Lemma~\ref{lemma:comb:master}]
      Let $k \in \mathbb{N}, \mathcal{B}$ PPT algorithm such that
      \begin{equation*}
        \Pr\left[\mathsf{master \mhyphen EUF \mhyphen
    ...
    \begin{proof}[Proof of Theorem~\ref{thm:combsign}]
