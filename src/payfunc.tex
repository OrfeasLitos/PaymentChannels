    ...
    \begin{systembox}{\fpaynet - preamble}
      ...
      \begin{itemize}
        ...
        \begin{itemize}
          ...
          \item (\textsc{resolvePay}, \textit{payid}, \texttt{charged})
    ...
    \begin{systembox}{\fpaynet - support}
      \begin{algorithmic}[1]
        ...
        \Indent
          ...
          block number to \texttt{polls}(\alice) \TODO{send \ledger{} to
          \simulator{} btw often}
  ...
  \begin{figure}[H]
    \begin{systembox}{\fpaynet - pay}
      \begin{algorithmic}[1]
        ...
        \State Upon receiving $\left(\textsc{resolvePays}, \mathit{payid},
        \mathtt{charged}\right)$ from \simulator: \TODO{fix}
        \Indent
          ...
          \mathtt{corrupted} \ \vee$ (\texttt{polls}(\texttt{charged}) contains
          an element in $\left[\mathtt{OutgoingCltvExpiry} + 2k + \tochain{} -
          1, \mathtt{IncomingCltvExpiry} - \TODO{2?}k - \tochain{} - 1\right]
          \wedge$ \texttt{focs}(\texttt{charged}) contains
    ...
    \begin{systembox}{\fpaynet - poll}
      \begin{algorithmic}[1]
        ...
        \Indent
          ...
          \texttt{toReport}(\textit{reportid}), \alice, \textit{reportid}) to
          \simulator
        \EndIndent
        \Statex
