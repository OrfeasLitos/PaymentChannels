            ...
            \mathtt{charged}\left(\alice\right)$}
              ...
              \Else \ \Comment{\dave{} honest}
                ...
                \ElsIf{$\dave{} \neq \alice$}
                  ...
                  $\mathtt{remoteCom}_m$}
                    \If{$\mathtt{IncomingCltvExpiry} -
                    \mathtt{OutgoingCltvExpiry} < \mathtt{relayDelay}(\alice) +
                    \tochain{} \vee$ (\texttt{polls}(\dave) contains two
                    elements in $[\mathtt{OutgoingCltvExpiry},
