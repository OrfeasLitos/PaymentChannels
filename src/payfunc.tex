    ...
    \begin{systembox}{\fpaynet - poll}
      \begin{algorithmic}[1]
        ...
        \Indent
          ...
          \ForAll{maliciously closed \texttt{channel}s by a remote commitment
