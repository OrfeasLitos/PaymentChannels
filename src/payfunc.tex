        ...
        \Indent
          \ForAll{$\alice \text{ keys} \in \texttt{charged}$}
            ...
            \mathtt{charged}\left(\alice\right)$}
              ...
              ($\Sigma_{\dave}$ does not contain such a $\mathtt{remoteCom}_m \
              ...
              \label{alg:fpaynet:resolvepay:updateloop}
