  ...
  \begin{algorithmic}[1]
    ...
    \Indent
      ...
      \texttt{pending}}
        ...
        \mathrm{forFundTX}\right)$ to $Bob$ \Comment{TODO: send correct message
        to Bob with keys instead of forFundTX, as in protocol}
      \EndIf
    \EndIndent
    \State
    ...
    \Indent
      \If{\texttt{receipt} contains $Alice$ and is contained in \texttt{receipts}}
        ...
        \State $Bob \gets$ the other party in \texttt{receipt}
