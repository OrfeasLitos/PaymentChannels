  ...
  \begin{protocolbox}{$\Pi_{\mathrm{LN}}$ - \textsc{checkNew}}
    \begin{algorithmic}[1]
      ...
      \Indent
        ...
        \mathrm{KeyShareGen}\left(\mathrm{prand}_2\right)$
  ...
  \begin{protocolbox}{$\Pi_{\mathrm{LN}}$ - invoice}
    \begin{algorithmic}[1]
      ...
      \Indent
        ...
        an open $\mathtt{channel} \in \mathtt{channels}$ in which we have at
        least $x$.
      ...
      \Indent
        ...
        \TODO{\alice{} doesn't know these Bob, RHS delays}
  ...
  \begin{protocolbox}{$\Pi_{\mathrm{LN}}$ - \textsc{push}}
    \begin{algorithmic}[1]
      ...
      \Indent
        ...
        \State send (\textsc{updateFulfillHtlc}, \textit{pchid}, HTLC\_no, $R$)
