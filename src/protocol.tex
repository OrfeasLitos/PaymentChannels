        ...
        \Indent
          ...
          \ForAll{channels}
            ...
            $\left[t, t + \tochain{}\right]$}
              ...
              \texttt{toSubmit}
              \State $\mathtt{focDiffs} \gets \emptyset$
              ...
              message in response to which we generated and sent $h_i$)}
                \State append (\textit{expayid}, $-x$) to \texttt{focDiffs}
              \EndFor
              \If{$\mathtt{focDiffs} \neq \emptyset$}
                \State append (\texttt{receipt}(\texttt{channel}),
                \texttt{focDiffs}) to \texttt{updatesToReport}
                \label{alg:protocol:pay:foc:update}
              \EndIf
            \EndIf
          \EndFor
          \State send (\textsc{submit}, \texttt{toSubmit}) to \ledger
