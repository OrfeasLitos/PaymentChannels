...
\begin{protocolbox}{$\Pi_{\mathrm{LN}}$ - \textsc{openChannel}
from \environment}
  ...
  \begin{algorithmic}[1]
    ...
    \Indent
      ...
      \mathrm{KeyGen}\left(\mathrm{prand}_1\right)$
...
\begin{protocolbox}{$\Pi_{\mathrm{LN}}$ - \textsc{acceptChannel}}
  ...
  \begin{algorithmic}[1]
    ...
    \Indent
      ...
      \State $pt_{\mathrm{rev}, 1} \gets ptb_{\mathrm{rev}} \cdot
      \mathcal{H}\left(ptb_{\mathrm{rev}} || pt_{\mathrm{com}, 1}\right) +
      ph_{\mathrm{com}, 1} \cdot \mathcal{H}\left( pt_{\mathrm{com}, 1} ||
      ptb_{\mathrm{rev}}\right)$
      \State $ph_{\mathrm{dpay}, 1} \gets phb_{\mathrm{dpay}} +
      \mathcal{H}\left(ph_{\mathrm{com}, 1} || phb_{\mathrm{dpay}}\right)$
      \State $ph_{\mathrm{pay}, 1} \gets phb_{\mathrm{pay}} +
      \mathcal{H}\left(ph_{\mathrm{com}, 1} || phb_{\mathrm{pay}}\right)$
...
\begin{protocolbox}{$\Pi_{\mathrm{LN}}$ - \textsc{fundingCreated}}
  ...
  \begin{algorithmic}[1]
    ...
    \Indent
      ...
      \State $ph_{\mathrm{rev}, 1} \gets phb_{\mathrm{rev}} \cdot
      \mathcal{H}\left(phb_{\mathrm{rev}} || ph_{\mathrm{com}, 1}\right) +
      pt_{\mathrm{com}, 1} \cdot \mathcal{H}\left( ph_{\mathrm{com}, 1} ||
      phb_{\mathrm{rev}}\right)$
      \State $pt_{\mathrm{dpay}, 1} \gets ptb_{\mathrm{dpay}} +
      \mathcal{H}\left(pt_{\mathrm{com}, 1} || ptb_{\mathrm{dpay}}\right)$
      \State $pt_{\mathrm{pay}, 1} \gets ptb_{\mathrm{pay}} +
      \mathcal{H}\left(pt_{\mathrm{com}, 1} || ptb_{\mathrm{pay}}\right)$
...
\textsc{commitmentSigned}}
  ...
  \begin{algorithmic}[1]
    ...
    \Indent
      ...
      \mathrm{KeyGen}\left(\mathrm{prand}_{n+2}\right)$
...
\textsc{revokeAndAck}}
  ...
  \begin{algorithmic}[1]
    ...
    \Indent
      ...
      \mathcal{H}\left(phb_{\mathrm{rev}} || ph_{\mathrm{com},
      n}\right) + st_{\mathrm{com}, n} \cdot \mathcal{H}\left(ph_{\mathrm{com},
      n} || phb_{\mathrm{rev}}\right)$
      \State $ph_{\mathrm{rev}, n+2} \gets phb_{\mathrm{rev}}
      \cdot \mathcal{H}\left(phb_{\mathrm{rev}} ||
      ph_{\mathrm{com}, n+2}\right) + pt_{\mathrm{com}, n+2} \cdot
      \mathcal{H}\left(ph_{\mathrm{com}, n+2} ||
      phb_{\mathrm{rev}}\right)$
      \State $pt_{\mathrm{rev}, n+2} \gets ptb_{\mathrm{rev}}
      \cdot \mathcal{H}\left(ptb_{\mathrm{rev}} ||
      pt_{\mathrm{com}, n+2}\right) + pt_{\mathrm{com}, n+2} \cdot
      \mathcal{H}\left( pt_{\mathrm{com}, n+2} ||
      ptb_{\mathrm{rev}}\right)$
      \State $ph_{\mathrm{dpay}, n+2} \gets phb_{\mathrm{dpay}} +
      \mathcal{H}\left(ph_{\mathrm{com}, n+2} ||
      phb_{\mathrm{dpay}}\right)$
      \State $pt_{\mathrm{dpay}, n+2} \gets ptb_{\mathrm{dpay}} +
      \mathcal{H}\left(pt_{\mathrm{com}, n+2} ||
      ptb_{\mathrm{dpay}}\right)$
      \State $ph_{\mathrm{pay}, n+2} \gets phb_{\mathrm{pay}} +
      \mathcal{H}\left(ph_{\mathrm{com}, n+2} ||
      phb_{\mathrm{pay}}\right)$
      \State $pt_{\mathrm{pay}, n+2} \gets ptb_{\mathrm{pay}} +
      \mathcal{H}\left(pt_{\mathrm{com}, n+2} ||
      ptb_{\mathrm{pay}}\right)$
      \State $ph_{\mathrm{htlc}, n+2} \gets phb_{\mathrm{htlc}} +
      \mathcal{H}\left(ph_{\mathrm{com}, n+2} ||
      phb_{\mathrm{htlc}}\right)$
      \State $pt_{\mathrm{htlc}, n+2} \gets ptb_{\mathrm{htlc}} +
      \mathcal{H}\left(pt_{\mathrm{com}, n+2} ||
      ptb_{\mathrm{htlc}}\right)$
    \EndIndent
  \end{algorithmic}
\end{protocolbox}
