    ...
    \begin{protocolbox}{$\Pi_{\mathrm{LN}}$ - \textsc{acceptChannel}}
      \begin{algorithmic}[1]
        ...
        \Indent
          ...
          \textsc{Sign}(TX, $sk_{\alice}$), output 0 pays $y - x$ to
          ...
          \State $\mathrm{sig} \gets \textsc{Sign}\left(\mathtt{remoteCom}_1,
          sh_F\right)$
    ...
    \begin{protocolbox}{$\Pi_{\mathrm{LN}}$ - \textsc{fundingCreated}}
      \begin{algorithmic}[1]
        ...
        \Indent
          ...
          \State ensure $\textsc{Verify}\left(\mathtt{BobSig}_1,
          ...
          \State $\mathrm{sig} \gets \textsc{Sign}\left(\mathrm{remoteCom}_1,
          sh_F\right)$
    ...
    \begin{protocolbox}{$\Pi_{\mathrm{LN}}$ - \textsc{fundingSigned}}
      \begin{algorithmic}[1]
        ...
        \Indent
          ...
          \texttt{pendingOpen}
          \State $\mathrm{sig} \gets \textsc{Sign}\left(F,
          ...
          above, with channel id \textit{pchid}}
            \ForAll{received HTLC outputs $i$ of $\mathtt{remoteCom}_n$}
              ...
              \texttt{HTLCNo} and $R$}
                ...
                \State $\mathrm{sig} \gets \textsc{Sign}\left(TX,
      ...
      \begin{algorithmic}[1]
        ...
        \label{alg:protocol:poll:closedch:loop}
          ...
          \Else \ \Comment{malicious closure}
            ...
            \State $\mathrm{sig} \gets \textsc{Sign}\left(\mathrm{rev},
        ...
        \Indent
          ...
          hash $h$ with number $\mathtt{HTLCNo}'$} \Comment{We are intermediary}
            ...
            \Comment{counterparty has gone on-chain}
              ...
              $pk_{\alice}$\}
              \State $\mathrm{sig} \gets \textsc{Sign}\left(\mathrm{TX},
              sh_{\mathrm{htlc}, n}\right)$
    ...
    \begin{protocolbox}{$\Pi_{\mathrm{LN}}$ - \textsc{commit}}
      \begin{algorithmic}[1]
        ...
        \Indent
          ...
          \textsc{Sign}\left(\mathtt{remoteCom}_{n+1}, sh_F\right)$
          ...
          \For{$i$ from \texttt{lastRemoteSigned} to \texttt{HTLCNo}}
            ...
            \State add $\textsc{Sign}\left(\mathtt{remoteHTLC}_{n+1, i},
            sh_{\mathrm{htlc}, n+1}\right)$ to HTLCSigs
          \EndFor
          \State add $\textsc{Sign}\left(\mathtt{remoteHTLC}_{n+1, m+1},
          sh_{\mathrm{htlc}, n+1}\right)$ to HTLCSigs
    ...
    \begin{protocolbox}{$\Pi_{\mathrm{LN}}$ - \textsc{commitmentSigned}}
      \begin{algorithmic}[1]
        ...
        \Indent
          ...
          \Comment{there are uncommitted updates}
          \If{$\textsc{Verify}\left(\mathtt{comSig}_{n+1}, \mathtt{localCom},
          ...
          \For{$i$ from \texttt{lastLocalSigned} to \texttt{HTLCNo}}
            ...
            \mathtt{remoteDelay} \text{ relative}\right)\right)$\}
            \If{$\textsc{Verify}\left(\mathtt{HTLCSigs}_{n+1, i},
    ...
    \begin{protocolbox}{$\Pi_{\mathrm{LN}}$ - \textsc{revokeAndAck}}
      \begin{algorithmic}[1]
        ...
        \Indent
          ...
          \textsc{CombineKey}\left(shb_{\mathrm{rev}}, phb_{\mathrm{rev}},
    ...
    \begin{protocolbox}{$\Pi_{\mathrm{LN}}$ - close}
      \begin{algorithmic}[1]
        ...
        \Indent
          ...
          $i$}
            \State $\mathrm{sig} \gets \textsc{Sign}\left(\mathtt{localHTLC}_{n,
            i}, sh_{\mathrm{htlc}, n}\right)$
            \State add $\left(\mathrm{sig}, \mathtt{HTLCSigs}_{n, i},
            \mathtt{localHTLC}_{n, i}\right)$ to HTLCs
          \EndFor
          \State $\mathrm{sig} \gets \textsc{Sign}\left(\mathtt{localCom}_n,
          sh_F\right)$
          \State add \texttt{receipt}(\texttt{channel}) to
          \texttt{closedChannels}
