      ...
      \begin{algorithmic}[1]
        ...
        \Indent
          ...
          \ForAll{channels}
            ...
            transaction without those HTLCs to counterparty, but have not
            received the corresponding \textsc{revokeAndAck}s AND some of the
            HTLCs expire within $\left[t, t + \tochain{}\right]$}
              ...
              received a (\textsc{sendInvoice}, $x$, \textit{expayid},
    ...
    \begin{protocolbox}{$\Pi_{\mathrm{LN}}$ -- close unilaterally}
      \begin{algorithmic}[1]
        ...
        \Indent
          ...
          $i$}
            \If{there is a (\_, $R$, \textit{expayid}, \textit{payid}, $x$)
            entry in \texttt{gotPaid} for $R$ the preimage of $\mathrm{HTLC}_i$}
