\ \\ \noindent {$\Pi_{\mathrm{LN}}$} (self is \textit{Alice})
  ...
  \begin{algorithmic}[1]
    ...
    \Indent
      ...
      $pk_{\mathit{Alice}}$) to \adversary \orfeas{delay to \adversary{}
      needed?}
    \EndIndent
    \State
    ...
    \Indent
      ...
      \alice{} and has value at least $x$ \orfeas{this and previous in acceptCh}
      ...
      \State choose unique temporary ID \textit{tid} \orfeas{unique for
    ...
    pa_{\mathrm{pay}}, pa_{\mathrm{dpay}}, pa_{\mathrm{htlc}},
    pa_{\mathrm{com}1}, pa_{\mathrm{rev}}$, \textit{tid}) from \bob:
    \Indent
      \State $\left(\left(pb_F, sb_F\right), \left(pb_{\mathrm{pay}},
      sb_{\mathrm{pay}}\right), \left(pb_{\mathrm{dpay}},
      sb_{\mathrm{dpay}}\right), \left(pb_{\mathrm{htlc}},
      sb_{\mathrm{htlc}}\right), \left(pb_{\mathrm{com}1},
      sb_{\mathrm{com}1}\right),\right.$ $\left.\left(pb_{\mathrm{rev}},
      sb_{\mathrm{rev}}\right)\right) \gets \textsc{GetKeys}\left(\right)$
      ...
      pb_{\mathrm{com}1}, pb_{\mathrm{rev}}$, \textit{tid}) to \bob
    \EndIndent
    \State
