\ \\ \noindent {$\Pi_{\mathrm{LN}}$} The protocol is executed by player $Alice$.
  ...
  \begin{algorithmic}[1]
    ...
    \EndIndent
    \State
    \Procedure{OpenChannel}{source, dest, coins, delay, bcast}
      ...
      \Indent
        ...
        \State $\mathcal{F}_{\mathrm{Wallet}}.\mathrm{isValidPubKey}\left(pb_i\right)$ =
        True)
      \EndIndent
...
\State TODO: improve comments
    ...
    \EndProcedure
    \State
    \Procedure{GetFunding}{coins, $sa_F, pa_F, pb_F$}
      ...
      % TODO: move elsewhere
        ...
        \mathrm{coins}\right)\right)$ \Comment{more outputs allowed}
      \EndIndent
      \State \})
      \State idx $\gets 0$
    ...
    \EndProcedure
    \State
    \Procedure{P2WPKH}{$pk, \mathrm{funds}$}
