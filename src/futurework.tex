\redden{\section{Future Work}}
  ...
  the problem of unneeded precautionary channel closures. Moreover, transactions
  ...
  \redden{In a different direction, big parts of our main security proof consist
  ...
  sources of distinguishability. Developing an environment that aids in the
  production and verification of indistinguishability proofs in the framework of
  Universal Composability is left as future work.}

  \redden{The lightning specification is not static, but it is continuously
