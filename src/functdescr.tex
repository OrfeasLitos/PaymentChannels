...
\label{sec:ov-paynet}
  ...
  receives (\textsc{closeChannel}, \texttt{receipt}, \textit{tid}) or
  (\textsc{forceCloseChannel}, \texttt{receipt}, \textit{tid}) from \alice (for
  a cooperative or unilateral close respectively), it leaks to \simulator{} the
  fact that \environment{} wants to close the relevant channel.
