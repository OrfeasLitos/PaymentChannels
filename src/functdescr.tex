...
\label{sec:ov-paynet}
  ...
  \begin{itemize}
    ...
    honest party \aggelos{break to bullets/enumerate} either did not \textsc{poll} in time to catch a malicious
    ...
    of her funds (\aggelos{ Substitute by fulfill on chain message}) when the chain in
