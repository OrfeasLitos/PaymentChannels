...
\label{sec:ov-paynet}
  ...
  (\textsc{forceCloseChannel}, \texttt{receipt}, \textit{pchid}) from \alice
  (for a cooperative or unilateral close respectively), it leaks to \simulator{}
  the fact that \environment{} wants to close the relevant channel.
