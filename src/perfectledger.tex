...
\label{sec:perfect-ledger}
  ...
  parties; no delays can be introduced by the adversary. \redden{We refer the
  reader to Appendix~\ref{appendix:ledger} for the formal definition of
  $\FnetworkEd^1$.}

  The \redden{adversary} however may choose to send its own messages only to
  specific parties. This allows the adversary to spread conflicting information
  or withhold data from some parties. \redden{T}his adversarial ability
 ...
 \redden{The full proof can be found in
