\section{Security Proof}
  ...
  \begin{proof}
    ...
    ideal and line~\ref{alg:protocol:open:checkNew:valid} of
    Fig.~\ref{alg:protocol:open:checkNew} in the real world will allow execution
    to continue in the exact same cases with respect to the messages that
    \environment{} and \adversary{} send.
  \end{proof}
